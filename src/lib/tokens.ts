...
export type TokenConfig = { symbol: TokenSymbol; name: string; decimals: number; address: `0x${string}` };
...
export const BASE_TOKENS: Record<TokenSymbol, TokenConfig> = {
  ...
  USDT: { symbol: "USDT", name: "Tether USD", decimals: 6, address: "0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2" },
};
