      ...
      <div className="space-y-4">
        <label className="block">
          ...
          <select
            ...
            className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-white outline-none focus:border-emerald-300"
          >
        ...
        <label className="block">
          ...
          <div className="flex rounded-2xl border border-white/10 bg-black/40 focus-within:border-emerald-300">
            <input
              ...
              inputMode="decimal"
              className="min-w-0 flex-1 bg-transparent px-4 py-4 text-2xl outline-none"
              placeholder="0.00"
            />
